...
import grails.coin.coin.AnnonceService
import grails.coin.coin.Dto.AnnonceDto
import grails.coin.coin.Models.Annonce
import grails.coin.coin.Models.Illustration

@Secured('permitAll')
class AnnoncementController {
    ...
    @Transactional
    def create(AnnonceDto annunceDto) {
    ...
    @Transactional
    def update(AnnonceDto announceDto) {
